    ...
    <>
      <div className="flex flex-col items-center gap-[15vh] pt-[5rem] bg-hai-beige">
        <img src="/hackai+people.png" className="
          object-contain mt-[5vh] h-[50vh] w-[80%] z-10
        "/>
        ...
        <button onClick={() => window.open("https://coda.io/form/HackAI-2024-Application-Form_dpLYWJ67GbP", "_blank")}
          className="w-[16rem] h-[4rem] bg-white rounded-[0.8rem] text-hai-orange font-roboto text-[1.3rem] font-bold uppercase z-10 border-[3px] border-hai-orange hover:scale-[1.07] shadow-md"
        >
          Register Now
        </button>
      </div>
